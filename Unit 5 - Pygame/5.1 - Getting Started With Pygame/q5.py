...
Date: May 6th, 2026
Description: Creates a pygame GUI, with a red box infinitely traveling left on top of a yellow background.
"""
...
class Main:
    ...
    def entities(self):
        ...
        self.background.fill((255, 255, 0))    # yellow background
    ...
    def create_box(self):
        ...
        self.box_x, self.box_y = 0, 200
    
    def update(self):
        #modify box value
        self.box_x -= 5 #box_x= box_x+5   
        #check boundaries
        if self.box_x  < 0:
            self.box_x = 640
